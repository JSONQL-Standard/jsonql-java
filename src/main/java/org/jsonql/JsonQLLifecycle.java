 ...
 *
 * <p>Implement any subset of these hooks to customize behavior at each stage of the JSONQL
 * pipeline. All methods have default no-op implementations.
 *
 * <p>Query pipeline: beforeParse → afterParse → beforeValidate → afterValidate → beforeTranspile →
 * afterTranspile → beforeExecute → afterExecute → beforeHydrate → afterHydrate
 *
 * <p>Mutation pipeline: beforeCreate/beforeUpdate/beforeDelete → beforeTranspile → beforeExecute →
 * afterExecute → afterCreate/afterUpdate/afterDelete
 */
public interface JsonQLLifecycle {
    ...
    default Map<String, Object> beforeParse(Map<String, Object> query) {
        return query;
    }
    ...
    default Map<String, Object> beforeValidate(Map<String, Object> query) {
        return query;
    }
    ...
    default List<Map<String, Object>> beforeHydrate(List<Map<String, Object>> results) {
        return results;
    }

    /** Called after result hydration with the final nested results. */
    default List<Map<String, Object>> afterHydrate(List<Map<String, Object>> results) {
        return results;
    }
    ...
    default Map<String, Object> beforeCreate(Map<String, Object> mutation) {
        return mutation;
    }
    ...
    default Map<String, Object> beforeUpdate(Map<String, Object> mutation) {
        return mutation;
    }
    ...
    default Map<String, Object> beforeDelete(Map<String, Object> mutation) {
        return mutation;
    }
